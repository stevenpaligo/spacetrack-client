...
public class SortTests {
  ...
  @Test
  @DisplayName("Sort: Getters")
  public void test3() {

    // field
    assertEquals(new TestQueryField(), new Sort<>(new TestQueryField(), Direction.ASC).getField());


    // direction
    assertEquals(Direction.ASC, new Sort<>(new TestQueryField(), Direction.ASC).getDirection());
  }
