...
public class InTests {
  ...
  @Test
  @DisplayName("In: Successful call")
  public void test5() {

    assertDoesNotThrow(() -> {

      new SatCatQuery().setCredentials(credentials).addPredicate(new In<>(SatCatQueryField.INTERNATIONAL_DESIGNATOR, "2021-068", "2021-069")).execute();
    });
  }
